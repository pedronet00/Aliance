...
namespace Aliance.Infrastructure.Migrations
{
    ...
    [Migration("20251105231638_UpdateGUIDSundaySchool")]
    partial class UpdateGUIDSundaySchool
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.MissionCampaignDonation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MissionCampaignDonation", (string)null);
                });
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.ServicePresence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ServicePresence");
                });

            modelBuilder.Entity("Aliance.Domain.Entities.ServiceRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ServiceRole", (string)null);
                });
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.AccountPayable", b =>
                {
                    ...
                    b.OwnsOne("Aliance.Domain.ValueObjects.Money", "Amount", b1 =>
                        {
                            b1.Property<int>("AccountPayableId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.AccountReceivable", b =>
                {
                    ...
                    b.OwnsOne("Aliance.Domain.ValueObjects.Money", "Amount", b1 =>
                        {
                            b1.Property<int>("AccountReceivableId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.Budget", b =>
                {
                    ...
                    b.OwnsOne("Aliance.Domain.ValueObjects.Money", "TotalAmount", b1 =>
                        {
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.Event", b =>
                {
                    ...
                    b.OwnsOne("Aliance.Domain.ValueObjects.Money", "Cost", b1 =>
                        {
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.MissionCampaignDonation", b =>
                {
                    b.HasOne("Aliance.Domain.Entities.MissionCampaign", "Campaign")
                        .WithMany("Donations")
                    ...
                    b.OwnsOne("Aliance.Domain.ValueObjects.Money", "Amount", b1 =>
                        {
                            b1.Property<int>("MissionCampaignDonationId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("MissionCampaignDonationId");

                            b1.ToTable("MissionCampaignDonation");

                            b1.WithOwner()
                                .HasForeignKey("MissionCampaignDonationId");
                        });
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.PatrimonyMaintenance", b =>
                {
                    ...
                    b.OwnsOne("Aliance.Domain.ValueObjects.Money", "MaintenanceCost", b1 =>
                        {
                            b1.Property<int>("PatrimonyMaintenanceId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("PatrimonyMaintenanceId");

                            b1.ToTable("PatrimonyMaintenance");

                            b1.WithOwner()
                                .HasForeignKey("PatrimonyMaintenanceId");
                        });
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.Service", b =>
                {
                    ...
                    b.HasOne("Aliance.Domain.Entities.Location", null)
                        .WithMany("Services")
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.ServicePresence", b =>
                {
                    b.HasOne("Aliance.Domain.Entities.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("Aliance.Domain.Entities.CostCenter", b =>
                {
                    ...
                    b.Navigation("PatrimonyMaintenance");
                });
